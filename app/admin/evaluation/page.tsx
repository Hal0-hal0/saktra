...
import { CalendarDays, ChartColumnBig, ClipboardCheck, DoorClosed, Eye, RotateCcw, Sparkles } from "lucide-react"
...
export default function EvaluationPage() {
  ...
  return (
    <div className="space-y-8">
      <section className="rounded-[28px] border bg-[radial-gradient(circle_at_top_left,hsl(var(--primary)/0.18),transparent_38%),linear-gradient(135deg,hsl(var(--card)),hsl(var(--muted)/0.6))] p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Event Evaluations</h1>
